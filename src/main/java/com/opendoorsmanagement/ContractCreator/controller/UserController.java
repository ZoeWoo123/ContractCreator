package com.opendoorsmanagement.ContractCreator.controller;
...
import com.opendoorsmanagement.ContractCreator.domain.Contract;
import com.opendoorsmanagement.ContractCreator.domain.Owner;
import com.opendoorsmanagement.ContractCreator.domain.OwnerForTemp;
import com.opendoorsmanagement.ContractCreator.service.UserService;
import com.opendoorsmanagement.ContractCreator.utils.PDFTemplateUtil;
...
public class UserController {
	...
	public String exportPdf(HttpServletResponse response, HttpServletRequest request) throws Exception{
		...
		try {
			...
			baos = PDFTemplateUtil.createPDF(data, "contract.ftlh");
